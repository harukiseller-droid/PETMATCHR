...
export default function BreedComparisonSelector({ breeds }: BreedComparisonSelectorProps) {
    ...
    return (
        <div className="bg-white p-8 rounded-2xl max-w-2xl mx-auto border border-neutral-200 shadow-sm">
            ...
            <div className="grid gap-6 md:grid-cols-2 mb-6">
                <div className="space-y-2">
                    <label className="text-sm font-medium text-neutral-500">Breed 1</label>
                    <select
                        value={breed1}
                        onChange={(e) => setBreed1(e.target.value)}
                        className="w-full rounded-lg bg-white border border-neutral-200 px-4 py-3 text-neutral-900 focus:border-secondary-500 focus:ring-1 focus:ring-secondary-500 outline-none transition-all"
                    >
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-neutral-500">Breed 2</label>
                    <select
                        value={breed2}
            ...
            <button
                ...
                className="w-full rounded-full bg-secondary-500 px-8 py-4 text-sm font-bold text-white transition-all hover:bg-secondary-400 hover:shadow-[0_0_20px_-5px_rgba(16,185,129,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
            >
