...
export default function HomePage() {
    return (
        <div className="relative overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-secondary-500/5 blur-[100px] rounded-full pointer-events-none" />
            ...
            <section className="relative border-b border-neutral-800/60">
                <div className="mx-auto flex max-w-5xl flex-col gap-12 px-4 py-20 md:flex-row md:items-center md:justify-between md:py-28">
                    <div className="max-w-xl space-y-8">
                        <div className="inline-flex items-center rounded-full border border-primary-500/20 bg-primary-500/10 px-3 py-1 text-xs font-medium text-primary-300 backdrop-blur-sm">
                        ...
                        <h1 className="text-4xl font-bold tracking-tight text-neutral-50 md:text-5xl lg:text-6xl text-balance leading-[1.1]">
                        ...
                        <p className="text-lg text-neutral-300 text-balance leading-relaxed">
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                            <Link
                                ...
                                className="inline-flex items-center justify-center rounded-full bg-primary-500 px-8 py-4 text-sm font-bold text-neutral-950 transition-all hover:bg-primary-400 hover:shadow-[0_0_20px_-5px_rgba(245,158,11,0.4)]"
                            >
                                Take the 60-second lifestyle quiz
                            </Link>
                            <Link
                                href="/breeds/golden-retriever"
                                className="inline-flex items-center justify-center rounded-full border border-neutral-700 bg-neutral-800/50 px-8 py-4 text-sm font-semibold text-neutral-200 transition-all hover:border-neutral-500 hover:bg-neutral-800 hover:text-white"
                            >
                        ...
                        <ul className="space-y-2 text-sm text-neutral-400">
                            <li className="flex items-center gap-2">
                                <svg className="h-4 w-4 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                    ...
                    <div className="glass-panel mt-8 w-full max-w-sm rounded-2xl p-6 shadow-2xl shadow-black/50 md:mt-0 transform transition hover:scale-[1.02] duration-500">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="px-2 py-1 rounded bg-primary-500/20 text-[10px] font-bold text-primary-300 border border-primary-500/30">POPULAR</span>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <div className="rounded-xl bg-neutral-950/50 p-3 border border-neutral-800">
                                <p className="font-semibold text-secondary-400 text-xs mb-1">Living fit</p>
                                <p className="text-[10px] text-neutral-400 leading-snug">
                                    Best with active owners and space to move.
                                </p>
                            </div>
                            <div className="rounded-xl bg-neutral-950/50 p-3 border border-neutral-800">
                                <p className="font-semibold text-secondary-400 text-xs mb-1">Cost & risk</p>
                                <p className="text-[10px] text-neutral-400 leading-snug">
                        ...
                        <div className="flex flex-col gap-3 text-xs border-t border-neutral-800 pt-4">
                            <Link
                                href="/cost/golden-retriever-austin-tx"
                                className="flex items-center justify-between text-neutral-300 hover:text-primary-300 transition-colors group"
                            >
            ...
            {/* How it works */}
            <section className="border-b border-neutral-800/60 bg-neutral-950/50">
                <div className="mx-auto max-w-5xl px-4 py-20">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        <h2 className="text-3xl font-bold text-neutral-50 md:text-4xl mb-4">
                            How PetMatchr works
                        </h2>
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        {[
                            ...
                            <div key={i} className="glass-panel rounded-2xl p-8 hover:border-primary-500/30 transition-colors group">
                                <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary-400 mb-4">
                                    {item.step}
                                </p>
                                <h3 className="text-xl font-bold text-neutral-100 mb-3 group-hover:text-primary-300 transition-colors">
                                    {item.title}
                                </h3>
                    ...
                    <div className="mt-12 text-center">
                        <Link
                            href="/quiz/lifestyle-match"
                            className="inline-flex items-center justify-center rounded-full bg-primary-500 px-8 py-3 text-sm font-bold text-neutral-950 transition hover:bg-primary-400"
                        >
                ...
                <div className="mx-auto max-w-5xl px-4 py-20">
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                        {[
                            ...
                            <div key={i} className="flex flex-col justify-between rounded-2xl border border-neutral-800 bg-neutral-900/30 p-6 hover:bg-neutral-900/50 transition-colors">
                                <div>
                                ...
                                <Link
                                    href={card.link}
                                    className="text-sm font-semibold text-primary-400 flex items-center gap-2 hover:gap-3 transition-all"
                                >
            ...
            {/* Who it's for */}
            <section className="border-b border-neutral-800/60 bg-neutral-900/20">
                <div className="mx-auto max-w-5xl px-4 py-20">
                    <h2 className="text-3xl font-bold text-neutral-50 md:text-4xl text-center max-w-3xl mx-auto mb-16 text-balance">
                        Built for people who want a dog for the next 10–15 years,{" "}
                        <span className="text-primary-400">not just the next 10 days</span>.
                    </h2>
                    <div className="grid gap-8 md:grid-cols-3">
                        {[
                            {
                            ...
                            <div key={i} className="text-center">
                                <div className="w-12 h-12 mx-auto bg-neutral-800 rounded-full flex items-center justify-center mb-4 text-primary-400 font-bold text-lg">
                                    {i + 1}
                                </div>
            ...
            <section className="bg-neutral-950">
                <div className="mx-auto max-w-5xl px-4 py-20">
                    <div className="grid gap-12 md:grid-cols-[1.5fr,1fr] md:items-start">
                        <div>
                            <h2 className="text-2xl font-bold text-neutral-50 md:text-3xl mb-8">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <details key={i} className="group rounded-xl border border-neutral-800 bg-neutral-900/40 open:bg-neutral-900/80 transition-colors">
                                        <summary className="cursor-pointer p-4 font-semibold text-neutral-100 flex items-center justify-between">
                                            {faq.q}
                                            <span className="text-neutral-500 group-open:rotate-180 transition-transform">▼</span>
                                        </summary>
                                        <div className="px-4 pb-4 pt-0 text-sm text-neutral-400 leading-relaxed">
                                            {faq.a}
                                        </div>
                                    </details>
                                ))}
                        ...
                        <div className="glass-panel rounded-2xl p-8 text-center">
                            ...
                            <Link
                                href="/answers"
                                className="inline-flex items-center justify-center rounded-full bg-neutral-800 border border-neutral-700 px-6 py-2.5 text-sm font-semibold text-neutral-200 transition hover:bg-neutral-700 hover:text-white w-full mb-6"
                            >
                            ...
                            <div className="border-t border-neutral-800 pt-6">
                                ...
                                <Link
                                    href="/quiz/lifestyle-match"
                                    className="inline-flex items-center justify-center rounded-full bg-primary-500 px-6 py-2.5 text-sm font-bold text-neutral-950 transition hover:bg-primary-400 w-full"
                                >
            ...
            <footer className="border-t border-neutral-800 bg-neutral-950 py-12">
                <div className="mx-auto max-w-5xl px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="text-center md:text-left">
                        <p className="text-lg font-bold text-neutral-100">PetMatchr</p>
