...
→ throw CloudLLMError.
 ...
 Flow:
 Try callCloudLLM.
 Nếu CloudLLMError → fallback sang callLocalLLM.
 Nếu cả cloud + local đều fail → throw HybridLLMError.
...
Default: "hybrid".
 ...
 Chuẩn bị INPUT_JSON cho COMPARISON_PAGE_PROMPT
 Load đầy đủ:
...
Cost:
“Cost to own a {Breed} in {City}”
Behavior & anxiety:
Các problem/anxiety page quan trọng.
Comparisons:
2–3 comparison phổ biến.
...
list	3
 ...
 ------
 PHASE 16 – Content Quality, SEO, Intent & Quiz Depth
Mục tiêu:
...
16.1 On-page SEO – Meta, H1, Structure
 ...
 16.2 AEO & “AI Suggest” Readiness (Quick Answers, JSON API)
 ...
 16.3 Keyword Coverage & Intent Mapping (from Real Owners)
...
Location: ["best dogs for [city]", "is [breed] good for [city] climate"]
 ...
 Content phải có đoạn nói rõ:
 tổng chi phí 1st year vs recurring,
ví dụ tình huống “nếu bạn có ngân sách ~X/tháng”.
 ...
 16.4 Quiz Quality & Depth (Insurance, Behavior, Anxiety, Lifestyle)
Dựa trên quiz-types.ts và PHASE 8 (insurance-fit, behavior-check, anxiety-level, lifestyle-match).
 ...
 16.5 Realism & “No Fluff” Content Check
...
prompts
 ...
 Có nhắc tới ví dụ đời thực:
 "after work", "weekends", "small apartment", "backyard", "kids", "neighbors", "crate", "leash", "walks", "toys", "mental stimulation"…
